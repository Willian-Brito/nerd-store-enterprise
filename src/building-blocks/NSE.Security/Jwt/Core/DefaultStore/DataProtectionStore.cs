...
namespace NSE.Security.Jwt.Core.DefaultStore;
...
#pragma warning disable CA1416
                ...
                {
                    throw new Exception(
                        "Is not possible to determine which folder are the protection keys. NSE.Security.JwtSigningCredentials.Store.FileSystem or NSE.Security.JwtSigningCredentials.Store.EntityFrameworkCore");
                }
